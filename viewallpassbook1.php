                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                 ...
                 <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                       <a href="JavaScript:history.back()" class="nav-item nav-link" >Go Back</a>
                        ...
                        <a href="viewpigmyaccounts.php" class="nav-item nav-link ">View Pigmy Accounts</a>
        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                    ...
                    <h1 class="display-5 mb-4">View Transaction details</h1>
                    <p class="mb-0">This overview helps you to stay informed about your passbook current status and manage your Balance Amount efficiently.</p>
                </div>
                
				 <div class="contact-form" style="">
								<table class="table table-striped">
											<tr>
														<th class="bg-primary">Transaction_id</th>
													    <th class="bg-primary">Transaction_date</th>
														<th class="bg-primary">Description</th>
														<th class="bg-primary">Cr_amount</th>
														<th class="bg-primary">Dr_amount</th>
														<th class="bg-primary">Net_Balance</th>
														...
														<th class="bg-primary">Remark</th>
																   ...
																   include 'connects.php';
																	...
																	{
																	echo '<script type="text/javascript">alert("Your account is not approved once it is approved you will get transaction details.");</script>';
																	}
																?>
								</table>
