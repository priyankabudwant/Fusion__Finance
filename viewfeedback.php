        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                    ...
                    <h1 class="display-5 mb-4">View feedback</h1>
                    <p class="mb-0">View all the feedback given by the customer.</p>
                </div>
																   ...
																   $conn =connectdb();
																	...
																	if($result->num_rows>0)
																	{
																		...
																		echo '<tr>
																			...
																			<td>'.$row["message"].'</td>
																			<td>'.$row["cdate"].'</td>
																			<td><a href="allactions.php?fno='.$row["fno"].'"> Delete</a></td>
																		</tr>';
																		}  
																	}
																?>
