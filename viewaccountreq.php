        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                    ...
                    <h1 class="display-5 mb-4">View Account Request</h1>
                    <p class="mb-0">Check all account requested by the customer. 
                    </p>
                </div>
				 ...
				 <div class="contact-form" style="">
								<table >
											<tr>
														...
														<th class="bg-primary">NOMINEE NAME</th>
														<th class="bg-primary">NOMINEE NO</th>
														
														<th class="bg-primary">DEPOSIT AMMOUNT</th>
														<th class="bg-primary">OPEN DATE</th>
...
<?php
if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST['Cid'])&& isset($_POST['accept']))
{
	$query="UPDATE account SET status='Approved' where Cid='{$_POST['Cid']}'";
	$Cid=$_POST['Cid'];
	$sql = "CREATE TABLE passbook_$Cid
					(id INT(255) AUTO_INCREMENT PRIMARY KEY, 
					Transaction_id VARCHAR(255) NULL,
					Transaction_date VARCHAR(255) NULL,
					Description VARCHAR(255) NULL,
					Cr_amount VARCHAR(255) NULL,
					Dr_ammount VARCHAR(255) NULL,
...
if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST['Cid'])&& isset($_POST['reject']))
{
	$query="UPDATE account SET status='Not aproove' where Cid='{$_POST['Cid']}'";
	$statement=$mysqli->prepare($query);
	$statement->execute();
}
?>