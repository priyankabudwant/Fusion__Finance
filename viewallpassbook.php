            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="viewpigmyaccounts.php" class="nav-item nav-link ">View pigmy</a>
                ...
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
				 ...
				 <table >
											<tr>
														...
														<th class="bg-primary">OCCUPATION</th>
														...
														<th class="bg-primary">STATUS</th>
																   ...
																   <?php
																		...
																		if($mysqli->connect_error)
																			...
																			$sql="Select * from account where status='Approved'";
																			...
																			if($result->num_rows>0)
																			{
																				...
																				<td><a href="viewallpassbook1.php?Cid='.$row['Cid'].'"> view passbook</a></td>
																				</tr>';   
																				}         
																			}             
																			?>
