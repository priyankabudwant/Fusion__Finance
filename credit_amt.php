...
<html lang="en">
	...
	<div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                <h1 class="display-5 mb-4">Credit/Debit Ammount</h1></div>
				<center>
                <div class="row g-5 align-items-center" style="margin-left:500px;">
	...
	<div class="col-12">
         <div class="form-floating">
            <input type="number"  class="form-control" name="acc_no" placeholder="Customer ID" required>
             <label for="phone">Account number</label>
         </div>
    </div>
	
						<select name ="type" class="form-control" required >
								  <option class="default" value="" disabled selected>Credit/Debit</option>
	...
	<div class="col-12">
         <div class="form-floating">
            <input type="number" pattern="^[6789]\d{9,9}$" class="form-control" name="credit_amount" placeholder="Amount" required>
             <label for="phone">Amount</label>
         </div>
    </div>
    <div class="col-12">
        <button class="btn btn-primary w-100 py-3" name="credit_btn" value="Credit" >Credit/Debit</button>
    </div>
    </div>
