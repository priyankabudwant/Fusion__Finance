        ...
        <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                    ...
                    <h1 class="display-5 mb-4">View Loan Status</h1>
                    <p class="mb-0">This overview helps you to stay informed about your loans current status and manage your repayments efficiently.
                </div>
				 ...
				 <div class="contact-form" style="">
								<table class="table table-striped">
											<tr>
														...
														<th class="bg-primary">Repay From period</th>
														<th class="bg-primary">Repay To period</th>
