		 ...
		 <div class="container-fluid service py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                    ...
                    <h1 class="display-5 mb-4">View loan request</h1>
                    <p class="mb-0">check all the loan request submitted by customer.                   </p>
                </div>
			
			<div class="contact-form" style="">
			 <table  class="table table-striped">
			  <tr>
					<th class="bg-primary">Loan No</th>
					<th class="bg-primary">Customer id</th>
					<th class="bg-primary">Account no</th>
					 
					   <th class="bg-primary">Loan ammount</th>
					   <th class="bg-primary">Repayment period from</th>
					   <th class="bg-primary">Repayment period to</th>
					   <th class="bg-primary">Applied date</th>
					   <th class="bg-primary">Action</th>
					   <th class="bg-primary">More</th>
			  </tr>
<?php
...
if($mysqli->connect_error)
	...
	if($result->num_rows>0)
	{
		...
		{	
			...
			<td>'.$row['eperiod'].'</td>
			<td>'.$row['adate'].'</td>
			<td><a href="moreloans.php?Cid='.$row["Cid"].'"> more</a></td>
			<td>
			<form method="post">
...
<?php
if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST['loan_no'])&& isset($_POST['accept']))
{
	$query="UPDATE loan SET status='approved' where loan_no='{$_POST['loan_no']}'";
	$statement=$mysqli->prepare($query);
	$statement->execute();
}
if($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST['loan_no'])&& isset($_POST['reject']))
{
	$query="UPDATE loan SET status='not approved' where loan_no='{$_POST['loan_no']}'";
	$statement=$mysqli->prepare($query);
	$statement->execute();
}
?>