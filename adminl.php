        ...
        <div class="container-fluid p-0">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent px-4 px-lg-5 py-3 py-lg-0">
                <a href="index.html" class="navbar-brand p-0">
                    <h1 class="display-6 text-primary m-0"> <img src="img/LOGO.png" alt="Logo"> </img>Fusion Finance</h1>
        ...
        <div class="container-fluid contact py-5">
            <div class="container py-5">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 900px;">
                    ...
                    <h1 class="display-5 mb-4">LOGIN FORM</h1>
                    <p class="mb-0">
                    </p>
                </div>
                <div id="contact">
            <div class="line">
               ...
               <div class="margin">
                  ...
                  <div class="s-12 m-12 l-5">
                    <h3>Login form</h3>
                    <form class="customform" method="post" action="admin_login_page.php">
                      <div class="s-12"><input name="adminid" placeholder="Admin ID" title="UserID" type="text" /></div>
                      <div class="s-12"><input name="adminpassword" placeholder="Admin Password" title="Your name" type="password" /></div>
					  
                      <div class="s-12 m-12 l-4"><button class="color-btn" name="loginbtn" type="submit">Login</button></div>
                    </form>
                  </div>                
               </div>
            </div>
