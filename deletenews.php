...
.row:after {
  ...
  clear: both;
    ...
    <body>
		...
		<div class="container-fluid service py-5">
         ...
         <h1 class="display-5 mb-4">View News</h1>
  ...
  <div class="leftcolumn">
    <div class="card">
      <h2>'.$row["heading"].'</h2>
	  <div class="fakeimg" style="height:200;width:200;"><img src="images/'.$row["image"].'" height="200" width="400" alt="#"/> </div>
      <h5> '.$row["cat"].', Dec 7, 2017</h5>
      
      <p>'.$row["Ndesc"].'</p>
	  <a href="allactions.php?nid='.$row["nid"].'" class="btn btn-primary w-100 py-3"> Delete</a>
    </div>
